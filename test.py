...
if __name__ == "__main__":
    ...
    with tf.Session() as sess:
        ...
        test(end=opt.endloc,
             ...
             RL=RL)
    # with tf.Session() as sess:
    #     RL = DeepQNetwork(env.actionsize1, env.actionsize2, env.statesize,
    #                       sess=sess,
    #                       learning_rate=0.001,
    #                       reward_decay=0.9,
    ...
    #     placename=opt.place
    #     ss=opt.place
    #     saver.restore(sess, tf.train.latest_checkpoint('./checkpoint_dir/single/%s' % (ss)))
    #     env.loaddata(keywordversion=2,loadname=placename)
    #     test(end=opt.endloc,
    #          nowtime=opt.tottime,
    #          daytime=opt.daytime,
    ...
    #          RL=RL)
    # with tf.Session() as sess:
    #     RL = agentdouble.DQN2(env.actionsize1, env.actionsize2, env.statesize, sess=sess,epsilon=0.0)
    #     saver = tf.train.Saver()
    #     placename=opt.place
    #     ss=opt.place
    #     saver.restore(sess, tf.train.latest_checkpoint('./checkpoint_dir/double/%s' % (ss)))
    #     env.loaddata(keywordversion=2,loadname=placename)
    #     test(end=opt.endloc,
    #          nowtime=opt.tottime,
    #          daytime=opt.daytime,
